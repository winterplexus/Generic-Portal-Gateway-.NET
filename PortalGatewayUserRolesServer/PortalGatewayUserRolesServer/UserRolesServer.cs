...
namespace PortalGatewayUserRolesServer
{
    ...
    {
        private static readonly string temporaryFileExtension = ".tmp";
        ...
        {
            var temporaryUserRolesDataFilePath = userRolesDataFilePath + temporaryFileExtension;
        ...
        private static UserRoles ParseRecord(string record, int recordNumber)
        {
            ...
            try
            {
                ...
                if (enumerator.MoveNext() || enumerator.Current != null)
                {
                    userRoles.UserFullName = Convert.ToString(enumerator.Current, CultureInfo.InvariantCulture).ToUpperInvariant().Trim();
                }
                if (enumerator.MoveNext() || enumerator.Current != null)
                {
                    userRoles.SupervisorFullName = Convert.ToString(enumerator.Current, CultureInfo.InvariantCulture).ToUpperInvariant().Trim();
                }
            }
